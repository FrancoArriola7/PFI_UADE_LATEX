...
\usepackage{amssymb}
% ya tenés amssymb, pero lo dejo por las dudas
\usepackage{amssymb}

% macros para usar en tablas de texto
\newcommand{\cmark}{\ensuremath{\checkmark}} % sí
\newcommand{\pmark}{\ensuremath{\sim}}        % parcial
\newcommand{\xmark}{}                         % no (celda vacía)
