...
\section{Solución}\label{sec:solucion}
...
\vspace{1cm}
\subsection{Tecnologías utilizadas}\label{sec:tecnologias}
...
\subsubsection{Next.js (React + TypeScript)}
...
\subsubsection{Tailwind CSS y \textit{shadcn/ui}}
...
\subsubsection{PostgreSQL (vía Supabase)}
...
\subsubsection{PostgREST (Supabase)}
...
\subsubsection{Node.js y \texttt{npm}}
...
\subsubsection{Utilitarios de CSV}
...
\subsubsection{Buenas prácticas de configuración y seguridad}
\begin{itemize}
...
\vspace{1cm}
\subsection{Identidad de marca}\label{sec:brand}
...
\subsubsection{Paleta de colores}\label{subsec:paleta}
