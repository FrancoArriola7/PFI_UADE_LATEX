...
Antes de detallar la metodología empleada, el análisis financiero se orienta a traducir los supuestos económicos del modelo de negocio en proyecciones cuantitativas que permitan estimar ingresos, costos, márgenes y sostenibilidad en el tiempo. Este apartado integra las variables clave del esquema de suscripción (adquisición, conversión, retención y estructura de costos) dentro de un modelo numérico que posibilita evaluar la salud financiera del proyecto bajo distintos ritmos de crecimiento. De este modo, el análisis financiero actúa como continuidad natural del estudio económico previo y proporciona una base objetiva para valorar la viabilidad del servicio, así como su potencial de escalabilidad.
...
\begin{table}[t]
    ...
    \begin{tabular}{|p{6cm}|p{3cm}|}
        ...
        \hline
        API de Clima (hasta 1000 usuarios) & $\sim 0$ \\
        \hline
