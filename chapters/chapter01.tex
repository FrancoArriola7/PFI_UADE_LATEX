...
\begin{itemize}
    ...
    \item Un sistema de carga de imágenes que permite al usuario subir registros de ventas directamente desde la interfaz web, extrayendo y almacenando automáticamente los datos a partir de las imágenes mediante LLMs multimodales.
