...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.7\textwidth]{images/FrecuenciaCompraPanificados.png}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.7\textwidth]{images/MomentoDeCompra.png}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.7\textwidth]{images/NoHubieraProducto.png}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.7\textwidth]{images/AccionPosterior.png}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.7\textwidth]{images/CompraSegunClima.png}
